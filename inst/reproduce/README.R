...
## on unbiased estimation of logarithms of normalizing constants, with lead author Maxime Rischard
###
...
# normal.R creates the three plots of Figure 1 and the confidence intervals; should take less than a minute
...
# logistic.laplace.R gives the last confidence interval in Section 3.2.1, corresponding to a path from a Laplace approx to the posterior
